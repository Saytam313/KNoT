    ...
    def _tokenizer( self, input_queue, output_queue ):
        ...
        while ( True ):
            ...
            if ( page is not None ):
                ...
                try:
                    ret_value = process.communicate( send_buff.encode(), timeout=2 )[0].decode()
                except subprocess.TimeoutExpired:
                    error = Functions.get_exception_info( 'Stranku se nepodarilo se nepodarilo zpracovat behem 2 sekund - "' + page.get_url() + '".' )
